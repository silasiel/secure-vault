...
## Developed by:
This app was created in collaboration with Faizah Hafeez(@faizahhafeez2-code), Sakina Fatima Mirza(@sakinastlw110), and myself(@silasiel) under the team name "Cipher Syndicate" for a junior level technical competition conducted by our college. <br>
